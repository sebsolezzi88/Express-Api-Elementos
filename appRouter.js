...
import { getAllElements, getElementByAtomicNumber, getElementBySymbol, getElementsByGroup, getElementsByPhase, getElementsByType, renderIndex } from "./appController.js";
...
router.get('/api/v1/name/:name',getElementBySymbol); //Obtener elemento por su nombre
